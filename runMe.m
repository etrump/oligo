...
Dp0BG = DiamSusp;
%[CS0 Cp0BG MSulf0BG Dp0BG NumConc0BG] = LoadSuspendedPopulation2(TotalSusp,TagSusp,DiamSusp,Sigma);
...
%[Cp0NP MSulfNP] = LoadSecondPopulation2(modelAtm.Pop,TotalOnWall,DpNP);
%LoadPopulationProps(modelAtm.Pop);

%for i = 1:n
%    Cp0((modelAtm.Pop-1)*n+i) = Cp0NP(i);
%end
%MSulf0(modelAtm.Pop) = MSulfNP;
%Dp0(modelAtm.Pop) = DpNP*1e-9;
%Dp0 = [DiamSusp DpNP]*1e-9;
